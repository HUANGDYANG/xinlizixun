...
function prepare () {
  ...
  self.createCtx = function () {
    var id = self.id;
    if (id) {
      self.ctx = wx.createCanvasContext(id, self.compoent ? self.compoent : '');
    } else {
...
function methods () {
  ...
  self.updateCanvas = function () {
      // console.log(11111111111111111, self.ctx)
  ...
  self.getCropperImage = function () {
    ...
    var quality = ref.quality; if ( quality === void 0 ) quality = 10;
        ...
        }, self.compoent ? self.compoent : ''); break

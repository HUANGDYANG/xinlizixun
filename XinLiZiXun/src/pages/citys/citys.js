Component({
    ...
    methods: {
        ...
        confirm() {
            ...
            const choosedCitys = this.data.choosedCitys.name;
            wx.setStorageSync("choosedCitys", choosedCitys);
            // wx.redirectTo({
            //       url: '/pages/be_mindful_screen?choosedCitys='+choosedCitys
            //     })
            ...
            // });
            this.triggerEvent('confirm', {choosedCitys}, true);
        },
